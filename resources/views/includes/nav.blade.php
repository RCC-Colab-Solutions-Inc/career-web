...
<header class="bg-white/90 dark:bg-slate-800/70 backdrop-blur-md sticky top-0 z-40 border-b border-slate-200 dark:border-slate-700 transition-colors duration-300">
            <div class="flex items-center justify-between px-6 h-16">
                ...
                <!-- Title or Empty Space for Middle (optional) -->
                ...
                <div class="flex items-center space-x-4 ml-auto">
                    ...
                    <!-- Notification Bell -->
                    <div class="relative">
                        <button class="p-1 text-slate-700 dark:text-blue-200 rounded-full hover:bg-slate-200 dark:hover:bg-slate-700 focus:outline-none transition-colors duration-300">
