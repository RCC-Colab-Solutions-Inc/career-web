        ...
        <main class="min-h-screen p-6">
            ...
            <div class="flex gap-6 h-[calc(100vh-12rem)]" x-data="{ selectedChat: null }">
                ...
                <div class="flex-1 flex flex-col">
                    ...
                    <!-- Chat Header -->
                    <div class="chat-header bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 p-4 rounded-t-lg" style="display: none;">
                        <div class="flex items-center justify-between">
                    ...
                    <!-- Messages Area -->
                    <div class="messages-container flex-1 overflow-y-auto p-6 bg-white dark:bg-slate-800 space-y-4" style="display: none;">
