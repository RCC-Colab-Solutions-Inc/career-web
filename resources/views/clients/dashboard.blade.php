        ...
        <div class="flex-1">
            ...
            <div class="p-6">
                ...
                <div class="relative h-96 mb-1">
                    <!-- New CV Card -->
                    <div class="absolute shadow-lg border border-gray-300 bg-white rounded-lg shadow p-4 flex items-center w-80 h-28" style="top: 20px; left: 30px;">
                    ...
                    <!-- Pending Card -->
                    <div class="absolute shadow-lg border border-gray-300 bg-white rounded-lg shadow p-4 flex items-center w-80 h-28" style="top: 20px; left: 420px;">
                        <div class="p-3 rounded-lg bg-blue-50 mr-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <!-- For Job Offer Card -->
                    <div class="absolute shadow-lg border border-gray-300 bg-white rounded-lg shadow p-4 flex items-center w-80 h-28" style="top: 20px; left: 800px;">
                        <div class="p-3 rounded-lg bg-blue-50 mr-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <!-- Hired Card -->
                    <div class="absolute shadow-lg border border-gray-300 bg-white rounded-lg shadow p-4 flex items-center w-80 h-28" style="top: 180px; left: 200px;">
                        <div class="p-3 rounded-lg bg-blue-50 mr-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <!-- Declined Card -->
                    <div class="absolute shadow-lg border border-gray-300 bg-white rounded-lg shadow p-4 flex items-center w-80 h-28" style="top: 180px; left: 600px;">
                ...
                <!-- Applicants Trends -->
                <div class="bg-white -mt-8 shadow-lg border border-gray-300 rounded-lg shadow p-6">
