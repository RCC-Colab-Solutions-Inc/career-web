...
<body style="margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', Arial, sans-serif; background-color: #f0f0f0; display: flex; justify-content: center; align-items: center; min-height: 100vh; padding: 20px;">
    <div style="width: 100%; max-width: 800px; background-color: white; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 40px;">
            <h1 style="color: #0A2472; font-size: 32px; margin-bottom: 10px; line-height: 1.2;">New CV's Arrived on your Dashboard.</h1>
            <p style="color: #666; font-size: 18px; margin-bottom: 30px;">Click to view the Dashboard</p>
            
            <a href="#" style="display: inline-block; background-color: #0A2472; color: white; padding: 15px 30px; text-decoration: none; border-radius: 8px; font-weight: bold; margin-bottom: 30px; min-width: 170px; text-align: center;">View Dashboard</a>
